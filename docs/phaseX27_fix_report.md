...
**File**: `ExcelAPI/Generators/WorkbookGenerator.cs` (lines 139–163, now removed)
...
**File**: `ExcelAPI/Services/WorkbookReaderService.cs` (lines 236–243, now removed)
...
**File**: `ExcelAPI/Generators/WorkbookGenerator.cs` (lines 209–268)
